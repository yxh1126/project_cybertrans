...
def populate():
    ...
    # Using the .items returns the key and the value. In this case the key is "Python",
    # "Django" or "Other Frameworks" and the value (cat_data) is the corresponding dictionary in cats.
